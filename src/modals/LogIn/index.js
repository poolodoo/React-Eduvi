                  ...
                  <Row className="bg-white_A700 items-center justify-end lg:p-[56px] xl:p-[70px] 2xl:p-[79px] 3xl:p-[94px] rounded-radius15">
                    ...
                    <Column className="items-center lg:ml-[56px] xl:ml-[71px] 2xl:ml-[80px] 3xl:ml-[96px] w-[41%]">
                      <Row className="bg-white_A700 border border-gray_301 border-solid items-center justify-center lg:p-[3px] xl:p-[4px] 2xl:p-[5px] 3xl:p-[6px] rounded-radius10 w-[92%]">
                        <Stack className="bg-red_602 lg:h-[29px] xl:h-[36px] 2xl:h-[41px] 3xl:h-[49px] lg:ml-[49px] xl:ml-[62px] 2xl:ml-[70px] 3xl:ml-[84px] lg:px-[5px] xl:px-[7px] 2xl:px-[8px] 3xl:px-[9px] rounded-radius7 lg:w-[28px] xl:w-[35px] 2xl:w-[40px] 3xl:w-[48px]">
                          <Img
                        ...
                        <Text
                          className="lg:ml-[10px] xl:ml-[13px] 2xl:ml-[15px] 3xl:ml-[18px] lg:mr-[43px] xl:mr-[54px] 2xl:mr-[61px] 3xl:mr-[73px] columnclassroomcours"
                          variant="body5"
                        >
                          Sign in with google
                        </Text>
                      ...
                      <Row className="items-start justify-center lg:mt-[19px] xl:mt-[24px] 2xl:mt-[28px] 3xl:mt-[33px] w-[68%]">
                        ...
                        <Text
                          className="2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[7px] xl:ml-[9px] columnclassroomcours"
                          variant="body5"
                        >
                      ...
                      <Column className="items-center justify-end lg:mt-[17px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] lg:pt-[4px] xl:pt-[6px] 2xl:pt-[7px] 3xl:pt-[8px] w-[100%]">
                        ...
                        <Button
                          className="font-medium lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[100%]"
                          size="md"
                        >
                          Sign In
                        </Button>
                        <Row className="items-end justify-between lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] py-[3px] w-[99%]">
                          <Row className="items-end w-[47%]">
                            ...
                            />
                            <Text
                              className="mb-[2px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] columnclassroomcours"
                              variant="body5"
                            >
                              Keep me signed in
                            </Text>
                          ...
                          <Text
                            className="mb-[2px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] columnclassroomcours"
                            variant="body5"
                          >
                            Forgot Password?
                          </Text>
